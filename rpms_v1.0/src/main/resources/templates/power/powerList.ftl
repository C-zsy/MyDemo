...
<div id="center">
    ...
    <div id="main">
        ...
        <form name="form2" method="post" action="powerDetails">
            <div id="table">
                <table id="ec_table">
                    ...
                    <tbody>
                    <#list powerList as list>
                        <tr class="lightdown" onmousemove="this.className='lightup';"
                            onmouseout="this.className='lightdown';">
                            <td><input name="checkone" type="checkbox" value="${list.resourceId}"/></td>
                            <td>${list.resourceName}</td>
                            <td><a href="powerUpdate?resourceId=${list.resourceId}">详情</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                        ...
                        <td colspan="3">
                            <ul>
                                <li><input name="add" type="button" value="添加权限"
                                           onclick="window.location='rolePowerList'" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="details" type="button" value="权限详情"
                                           onclick="window.location='powerDetails'" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                            </ul>
                        </td>
