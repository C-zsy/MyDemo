...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="powerDetails" onsubmit="return checkpower()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>权限详情</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <#list powerDetails as list>
                    <tr>
                        <td style="height: auto; width: 80px">权限名</td>
                        <td style="height: auto; width: auto">${list.resourceName}</td>
                        <td style="height: auto; width: auto">${list.detailsValue}</td>
                    </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <tr>
                        <td colspan="3">
                            <ul>
                                <li><input name="addPower" type="button" value="返回"
                                           onclick="window.location='powerList'" class="button"
