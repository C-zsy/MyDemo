...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="roomAdd" onsubmit="return checkroom()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    ...
                    <tr>
                        ...
                        <td>楼栋名</td>
                        <td><select name="buildName">
                                <option selected>--请选择--</option>
                                <option value="御龙国际">御龙国际</option>
                                <option value="碧园冲">碧园冲</option>
                            </select>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        <td>入住时间</td>
                        <td><input name="roomDate" type="text" value=""
                                   onfocus="show_cele_date(roomDate,'','',roomDate)"/></td>
                        <td>请输入业主入住日期</td>
                    </tr>
                    <tr>
                        <td>房型</td>
                    ...
                    <tr>
                        <td>用途</td>
                        <td><input name="roomUse" type="text" value="居住"/></td>
                        <td>房间用途默认为居住型</td>
                    </tr>
                    <tr>
                        <td>建筑面积</td>
