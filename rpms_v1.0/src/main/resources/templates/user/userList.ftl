...
<div id="center">
    ...
    <div id="main">
        <form action="searchUser.html" method="post" name="form1" onsubmit="return checkkey()">
            <div id="index">
                <span>查询条件：</span>
                <select name="oneway">
                ...
                <input name="onetext" type="text" value="请输入关键字" id="txt1" onfocus="selectText();"/>
                <input name="2" type="submit" value="搜索"/>
            </div>
        </form>

        <form name="form2" method="post" action="userDelete" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    ...
                    <tr>
                        <th>选中</th>
                        <th onclick="sortTable('ec_table',1,'string')">用户名</th>
                        <th onclick="sortTable('ec_table',2,'string')">角色名</th>
                        <th>修改</th>
                    </tr>
                    </thead>
                    ...
                    <tr onmouseover="this.className='lightup'" onmouseout="this.className='lightdown'">
                        <td><input name="checkone" type="checkbox" value="${list.userId}"/></td>
                        <td>${list.userName}</td>
                        <td>${list.roleName}</td>
                        <td><a href="userUpdate?userId=${list.userId}">修改</a></td>
                    </tr>
                    </tbody>
                    </#list>
                    <tfoot>
                    ...
                    <tr>
                        <td colspan="4">
                            <ul>
<#--                                <li><input name="addnews" type="button" value="添加用户" class="button"-->
<#--                                           onmouseout="this.className='button';"-->
<#--                                           onmouseover="this.className='buttondown';"-->
<#--                                           onclick="window.location='userAdd'"/></li>-->
                                <li><input name="sumselect" type="button" value="全部选择" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"
                                           onclick="checkAll();"/></li>
                                <li><input name="delete" type="submit" value="删除用户" class="button"
                                           onmouseout="this.className='button';"
