...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="buildUpdate" onsubmit="return checkbuild()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    ...
                    <tr>
                        <td>开工时间</td>
                        <td><input name="buildStart" type="text" value=""
                                   onfocus="show_cele_date(buildStart,'','',buildStart)"/></td>
                        <td>格式：xxxx-xx-xx</td>
                    </tr>
                    <tr>
                        <td>竣工时间</td>
                        <td><input name="buildFinish" type="text" value=""
                                   onfocus="show_cele_date(buildFinish,'','',buildFinish)"/></td>
                        <td>格式：xxxx-xx-xx</td>
                    </tr>
                    <tr>
                        <td>漏洞信息</td>
