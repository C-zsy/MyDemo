/*表格排序方法：
   使用办法，调用sortTable方法，三个参数分别代表，table的id名，该列位于哪一行，排序种类（int float string）
...
function getResource() {
    var r = document.getElementById("resource").value;//这个人获取到的资源权限有哪些
    for (var i = 0; i < r.length; i++) {
        document.getElementById("li" + r[i]).style.display = 'block';
    }
}
