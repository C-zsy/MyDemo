...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="insertGoods2" onsubmit="return checkmaterialadd()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>填写入库信息</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <tr>
                        <td>物资名称</td>
                        <td><input name="materialName" type="text" value=""/></td>
                        <td>物资名称不得超过8位</td>
                    </tr>
                    <tr>
                        <td>数量</td>
                        <td><input name="materialCount" type="text" value=""/></td>
                        <td>请输入物资数量</td>
                    </tr>
                    <tr>
                        <td>单价</td>
                        <td><input name="materialPrice" type="text" value=""/></td>
                        <td>请输入一个浮点型小数</td>
                    </tr>
                    <tr>
                        <td>物资类别</td>
                    ...
                    <tr>
                        <td>入库时间</td>
                        <td><input name="materialDate" type="text" value=""
                                   onfocus="show_cele_date(materialInDate,'','',materialInDate)"/></td>
                        <td>请输入时间，格式为yyyy-MM-dd</td>
                    </tr>
                    <tr>
                        <td>出库时间</td>
                        <td><input name="materialOutDate" type="text" value=""
                                   onfocus="show_cele_date(materialOutDate,'','',materialOutDate)"/></td>
                        <td>若物资未出库则填写入库日期</td>
                    </tr>
                    <tr>
                        <td>物资状态</td>
                        <td><select name="materialStat">
