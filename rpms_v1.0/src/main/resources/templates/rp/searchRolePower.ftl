...
<div id="center">
    ...
    <div id="main">
        <form action="SearchRolePower.do" method="post" name="form1">
            <div id="index">
        ...
        <form name="form2" method="post" action="RolePowerDelete.do" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    <caption>角色权限信息表</caption>
                    <thead>
                    <tr>
                        <th>选中</th>
                    ...
                    <tr onmouseover="this.className='lightup'" onmouseout="this.className='lightdown'">
                        <td><input name="checkone" type="checkbox" value="${rolePowerList.roleId}"/></td>
                        <td></td>
                        <td align="left">
                            <select name="select" multiple="multiple" size="6">
                                <option value="${rolePowerList.rolePowerId}"></option>

                            </select>
                        </td>
                        <td><a href="RolePowerPreUpdate.do?roleId=${rolePowerList.roleId}">edit</a></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <ul>
                                <li><input name="addRoles" type="button" value="添加权限"
                                           onclick="window.location='RolePowerPreAdd.do'" class="button"
                                ...
                                <li><input name="sumselect" type="button" value="全部选择" onclick="checkAll();"
                                           ...
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="deleteRolePowers" type="submit" value="删除权限" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                            </ul>
                        </td>
