...
<div id="center">
    ...
    <div id="main">
        <form name="rolePower" method="post" action="rolePowerUpdate" onsubmit="return ff();">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>角色权限修改</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <tr onmouseover="this.className='lightup'" onmouseout="this.className='lightdown'">
                        <td><input name="roleId" type="checkbox" value="${rolePowerUpdate.id}"/></td>
                        <td>角色名</td>
                        </td>
                        <td><input type="text" name="roleName" value="${rolePowerUpdate.Name}"
                    ...
                    <tr>
                        ...
                        <td>权限名</td>
                        <td>
                            <input type="text" name="roleResource" value="${rolePowerUpdate.Resource}"
