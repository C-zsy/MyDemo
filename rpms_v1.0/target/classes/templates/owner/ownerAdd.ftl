...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="ownerAdd" onsubmit="return checkowner()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>业主添加</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>籍贯</td>
                        <td><input name="ownerNative" type="text"/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>联系电话</td>
                    ...
                    <tr>
                        <td>身份证号</td>
                        <td><input name="ownerIden" type="text"/></td>
                        <td>请输入15位或18位身份证号</td>
                    </tr>
                    <tr>
                        <td>工作单位</td>
                        <td><input name="ownerDen" type="text"/></td>
                    ...
                    <tr>
                        ...
                        <td><select name="buildId">
                                ...
                                <option value="3">碧园冲</option>
                                <option value="6">简单家</option>
                            </select>
                        </td>
                        <td>请选择角色</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><select name="roleId">
                                ...
                                <option value="12">业主</option>
                                <option value="13">租户</option>
                            </select>
                        </td>
                        <td>请选择角色</td>
                    </tr>
