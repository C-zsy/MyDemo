...
<div id="center">
    ...
    <div id="main">
<#--        <form name="form1" method="post" action="ownerSearchList?pageIndex=1&pageSize=5" onsubmit="return checkkey()">-->
        <form name="form1" method="post" action="queryOwnerList?pageIndex=1&pageSize=5" onsubmit="return checkkey()">
                ...
                <table id="ec_table">
                    ...
                    <#list listQuery as list>
                        <tr onmouseover="this.className='lightup'" onmouseout="this.className='lightdown'">
                            ...
                            <td><a href="ownerUpdate?id=${list.owner_id}">edit</a></td>

                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <#--                    <div style="border: 1px ;height: auto;margin: 0 auto;">-->
<#--                    <table width="800">-->
                        <tr>
                            <td width="60">
                            ...
                            <td width="60">
                                <#if pageIndex!=1>
                                    <input onclick="javascript: top.location.href='queryOwnerList?pageIndex=${pageIndex-1}&pageSize=${pageSize}'"
                            ...
                            <td colspan="11">
                                <ul>
                                    ...
                                    <li><input name="addnews" type="button" value="添加业主"
                                               onclick="window.location='ownerAdd'" class="button"
                                               onmouseout="this.className='button';"
                                               onmouseover="this.className='buttondown';"/></li>
                                    <li><input name="sumselect" type="button" value="全部选择"
                                               onclick="checkAll();"
