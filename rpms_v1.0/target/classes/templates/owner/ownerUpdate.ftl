...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="ownerUpdate" onsubmit="return checkowner()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>业主信息修改</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <input type="hidden" name="ownerId" value="${newId}">

                    <tr>
                        <td>业主姓名</td>
                        <td><input name="ownerName" type="text" value="${update.owner_name}"/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>性别</td>
                        <td><select name="ownerSex">
                    ...
                    <tr>
                        <td>籍贯</td>
                        <td><input name="ownerNative" type="text" value="${c.owner_native}"/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>联系电话</td>
                        <td><input name="ownerPhone" type="text" value=""/></td>
                        <td>不得超过16位数字</td>
                    </tr>
                    <tr>
                        <td>身份证号</td>
                        <td><input name="ownerIden" type="text" value=""/></td>
                        <td>不得超过16位数</td>
                    </tr>
                    <tr>
                        <td>工作单位</td>
                        <td><input name="ownerDen" type="text" value=""/></td>
                        <td>请输入中文，不得超过16位数</td>
                    </tr>
                    <tr>
                        <td>楼栋名</td>
                        <td><select name="buildId">
                                ...
                                <option value="1">御龙国际</option>
                                <option value="2">碧园冲</option>
                                <option value="3">简单家</option>
...
<#--                                <option value="${room.roomId }" selected=selected>${room.roomName }</option>-->
                                <option selected>--请选择--</option>
                                <option value="11">鹿鸣阁</option>
                                <option value="12">栖子堂</option>
                                <option value="13">凌烟阁</option>
                                <option value="14">悦仙楼</option>
                                <option value="15">惜云亭</option>
