...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="chargeUpdate" onsubmit="return checkcharge()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>修改收费项目</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <tr>
                        <td>项目名称</td>
                        <input type="hidden" name="chargeId" id="chargeId" value="${c.chargeId}">
                        <td><input name="chargeName" type="text" value="${c.chargeName}" id="chargeName"/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>收费标准/元/m/月</td>
                        <td><input name="chargeUnit" type="text" value="${c.chargeUnit}" id="chargeUnit"/></td>
                        <td>请输入浮点型数据</td>
                    </tr>
