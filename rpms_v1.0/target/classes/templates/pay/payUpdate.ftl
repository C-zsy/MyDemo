...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="payUpdate" onsubmit="return checkpayupdate()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>修改缴费单</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <input type="hidden" name="payId" value="${newId}">
                    <tr>
                        <td>收费项目</td>
                        <td>
                            <select name="chargeId">
                                ...
                                <option value="4">管理费</option>
                                <option value="5">保护费</option>
                    ...
                    <tr>
                        <td>收费时间</td>
                        <td><input name="payDate" type="text" value="" onfocus="show_cele_date(payDate,'','',payDate)"/>
                        </td>
                        <td>请输入时间，格式为****-**-**</td>
                    </tr>
                    <tr>
                        ...
                        <td><select name="ownerId">
                                ...
                                <option value="1001">setsuna</option>
                                <option value="1002">kazusa</option>
                                <option value="1003">koharu</option>
                                <option value="1004">mari</option>
                                <option value="1005">chiaki</option>
