                ...
                <table id="ec_table">
                    ...
                    <#list listQuery as list>
                        <tr onmousemove="this.className='lightup';" onmouseout="this.className='lightdown';">
                            <td><input name="checkone" type="checkbox" value="${list.payId}"/></td>
                            <td>
                                <#if "${list.chargeId}" == 1>
                                    水电费
                                </#if>
                            ...
                            <td><a href="payUpdate?id=${list.payId}">edit</a></td>
                            <td><a href="paySend?id=${list.payId}">缴费</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <tr>
                        ...
                        <td width="60">
                            <#if pageIndex!=1>
                                <input onclick="javascript: top.location.href='queryPayList?pageIndex=${pageIndex-1}&pageSize=${pageSize}'"
                        ...
                        <td width="60">
                            <input onclick="javascript: top.location.href='queryPayList?pageIndex=${totalPage}&pageSize=${pageSize}'"
