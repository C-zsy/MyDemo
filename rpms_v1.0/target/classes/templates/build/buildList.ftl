...
<head>
    ...
    <script type="text/javascript">
        function pageData(pageIndex, pageSize) {
            location.href = "queryBuildList?pageIndex=" + pageIndex + "&pageSize=" + pageSize;
        }
        ...
        function fun() {
            ...
            location.href = "queryBuildList?pageIndex=1&pageSize=" + val.toString();
        }
    </script>
</head>
...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="buildSearchList" onsubmit="return checkkey()">
        ...
        <form name="form2" method="post" action="buildDelete" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    ...
                    <#list queryList as list>
                        <tr onmousemove="this.className='lightup';" onmouseout="this.className='lightdown';">
                            ...
                            <td><a href="buildUpdate?id=${list.buildId}">修改</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                        ...
                        <td colspan="7">
                            <ul>
                                ...
                                <li><input name="addnews" type="button" value="添加楼栋" class="button"
                                           ...
                                           onclick="window.location='buildAdd'"/></li>
