...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="memberUpdate" onsubmit="checkmember()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>业主成员修改</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <input type="hidden" name="memberId" value="${newId}">
                    <tr>
                        <td>楼栋名</td>
                    ...
                    <tr>
                        <td>业主名</td>
                        <td><select name="ownerName" id="select">

                                <option value="管理员" selected>管理员</option>
                                <option value="业主" selected>业主</option>
                                <option value="租户" selected>租户</option>
