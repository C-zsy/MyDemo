...
<head>
    ...
    <script>
        ...
        function clearData(pageSize) {
            location.href = 'queryMemberList?pageIndex=1&amp;pageSize=' + pageSize;
        }
        ...
        function choosePageSize() {
            ...
            location.href = 'queryMemberList?pageIndex=1&pageSize=' + v.toString();
...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="queryMemberList?pageIndex=1&pageSize=5" onsubmit="return checkkey()">
            ...
            <select name="oneway">
                ...
                <option value="5">按工作单位</option>
                <option value="6">按业主</option>
                <option value="7">按房间</option>
                <option value="8">按楼栋</option>
            </select>
            <input type="text" name="onetext" value="请输入关键字" id="txt1" onfocus="selectText();"/>
            <input type="submit" name="Submit" value="查询"/>
        </form>
        <form name="form2" method="post" action="memberDelete" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    <caption>业主成员信息表</caption>
                    <thead>
                    <tr>
                        <th>选中</th>
                        <th onclick="sortTable('ec_table',1,'string')">业主成员名</th>
                        <th onclick="sortTable('ec_table',2,'string')">楼栋名</th>
                        <th onclick="sortTable('ec_table',3,'string')">房间名</th>
                        <th onclick="sortTable('ec_table',4,'string')">业主名</th>
                        <th onclick="sortTable('ec_table',5,'string')">性别</th>
                        <th onclick="sortTable('ec_table',6,'string')">籍贯</th>
                        <th onclick="sortTable('ec_table',7,'string')">联系方式</th>
                        <th onclick="sortTable('ec_table',8,'string')">工作单位</th>
                        <th>修改</th>
                    </tr>
                    </thead>
                    <tbody>
                    <#list listQuery as list>
                        <tr onmousemove="this.className='lightup';" onmouseout="this.className='lightdown';">
                            <td><input name="checkone" type="checkbox" value="${list.member_id}"/></td>
                            ...
                            <td>
                                ...
                                <#if "${list.memberr_sex}" == 0>
                                    女
                                </#if>
                            </td>
                            <td>${list.member_native}</td>
                            <td>${list.member_phone}</td>
                            <td>${list.member_comp}</td>

                            <td><a href="memberUpdate?id=${list.member_id}">edit</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <tr>
                        <td width="60">
                            <input onclick="javascript: top.location.href='queryMemberList?pageIndex=1&pageSize=${pageSize}'"
                                   type="button" value="首页"/>
                        </td>
                        <td width="60">
                            <#if pageIndex!=1>
                                <input onclick="javascript: top.location.href='queryMemberList?pageIndex=${pageIndex-1}&pageSize=${pageSize}'"
                        ...
                        <td width="60">
                            <input onclick="javascript: top.location.href='queryMemberList?pageIndex=${totalPage}&pageSize=${pageSize}'"
                    ...
                    <tr>
                        <td colspan="10">
                            <ul>
                                ...
                                <li><input name="addnews" type="button" value="添加成员"
                                           onclick="window.location='memberAdd'" class="button"
                                ...
                                <li><input name="delete" type="submit" value="删除成员" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
