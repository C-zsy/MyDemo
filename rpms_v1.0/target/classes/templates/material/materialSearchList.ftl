...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="goodsSearch" onsubmit="return checkkey()">
                ...
                <table id="ec_table">
                    ...
                    <#list queryList as list>
                        <tr onmousemove="this.className='lightup';" onmouseout="this.className='lightdown';">
                            <td><input name="ids" type="checkbox" value="${list.materialId}"/></td>
                            <td>${list.materialName}</td>
                            <td>${list.materialCount}</td>
                            <td>${list.materialPrice}</td>
                            <td>${list.typeId}</td>
                            <td>${list.materialDate}</td>
                            <td>${list.materialOutDate}</td>

                            <td>在库</td>

                            <td><a href="updateGoods2?id=${list.materialId}">edit</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
