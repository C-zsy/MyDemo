...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="updateGoods3" onsubmit="return checkmaterialupdate();">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>修改物资信息</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <input type="hidden" name="materialId" value="${goodsId}">
                    <tr>
                        <td>物资名称</td>
                    ...
                    <tr>
                        <td>入库时间</td>
                        <td><input name="InDate" type="text" value="" onfocus="show_cele_date(InDate,'','',InDate)"/>
                        </td>
                        <td>请输入时间，格式为****-**-**</td>
                    </tr>
                    <tr>
                        <td>出库时间</td>
                        <td><input name="OutDate" type="text" value="" onfocus="show_cele_date(OutDate,'','',OutDate)"/>
                        </td>
                        <td>请输入时间，格式为****-**-**</td>
                    </tr>
                    <tr>
