...
<div id="center">
    ...
    <div id="main">
        ...
        <form name="form2" method="post" action="roleDelete" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    ...
                    <tr>
                        <td>选中</td>
                        <td onclick="sortTable('ec_table',1,'string')">角色名</td>
                        <td>修改</td>
                    </tr>
                    </thead>
                    <tbody>
                    <#list roleList as list>
                        <tr class="lightdown" onmousemove="this.className='lightup';"
                            ...
                            <td>${list.roleName}</td>
                            <td><a href="roleUpdate?roleId=${list.roleId}">修改</a></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <tr>
                        <td colspan="3">
                            ...
                            <ul>
                                ...
                                <li><span>转到</span>
                                    <select name="" id="pagenumber" onchange="role();">
                    ...
                    <tr>
                        <td colspan="3">
                            <ul>
                                <li><input name="addRoles" type="button" value="添加角色"
                                           onclick="window.location='roleAdd'" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="delete" type="submit" value="删除角色" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                            </ul>
                        </td>
