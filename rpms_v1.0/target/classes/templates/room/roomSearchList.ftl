...
<div id="center">
    ...
    <div id="main">
        <form name="hiddenform" method="post" action="roomSearchList" id="hiddenform" onsubmit="return checkkey()">
        ...
        <form name="form2" method="post" action="#" onsubmit="return befSubmit();">
            <div id="table">
                <table id="ec_table">
                    ...
                    <tbody>
                    <#list roomSearchList as list>
                        <tr onmousemove="this.className='lightup';" onmouseout="this.className='lightdown';">
                            <td><input name="checkone" type="checkbox" value="${list.room_id }"/></td>
                            ...
                            <td>${list.room_percent}</td>

                            <td><a href="roomUpdate">修改</a></td>
                        ...
                        <td colspan="9">
                            <ul>
                                ...
                                <li><input name="addnews" type="button" value="添加房间" class="button"
                                           ...
                                           onclick="window.location='roomAdd.html'"/></li>
