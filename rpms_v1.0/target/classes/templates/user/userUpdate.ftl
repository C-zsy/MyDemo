...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="userUpdate" onsubmit="return auth();">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    ...
                    <tr>
                        <td colspan="3">
                            <ul>
                                <li><input name="updateuser" type="submit" value="确定" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="userselect" type="reset" value="重置" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                            </ul>
                        </td>
