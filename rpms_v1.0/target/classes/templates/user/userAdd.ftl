...
<#--                    <li><a href="../owner/ownerAdd.ftl">增加业主</a></li>-->
<#--                    <li><a href="../owner/ownerList.ftl">修改业主</a></li>-->
<#--                    <li><a href="../owner/ownerList.ftl">查询业主</a></li>-->
<#--                    <li><a href="../owner/ownerList.ftl">删除业主</a></li>-->
<#--                </ul>-->
<#--            </li>-->
...
<#--                    <li><a href="../pay/payList.ftl">业主缴费</a></li>-->
<#--                    <li><a href="../pay/payList.ftl">缴费单查询</a></li>-->
<#--                    <li><a href="../pay/payList.ftl">修改收费记录</a></li>-->
<#--                    <li><a href="../pay/pagestat.ftl">缴费统计</a></li>-->
<#--                    <li><a href="../pay/payList.ftl">删除缴费</a></li>-->
<#--                </ul>-->
<#--            </li>-->
...
<#--        </ul>-->
    ...
    <div id="main">
        <form name="form1" method="post" action="register" onsubmit="return auth();">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    ...
                    <tr>
                        <td>用户名</td>
                        <td><input name="userName" type="text" value="" id="userName" onblur="createXMLHttpRequest()"/>
                            <font color="blue" id="div1"></font></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>用户密码</td>
                        <td><input name="userPassword" type="text" value=""/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <ul>
                                <li><input name="addUser" type="submit" value="确定" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="roleNameselect" type="reset" value="重置" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';"/></li>
                                <li><input name="relogin" type="button" value="返回登录" class="button"
                                           onmouseout="this.className='button';"
                                           onmouseover="this.className='buttondown';" onclick="javascript: top.location.href='index' "/></li>
                            </ul>
                        </td>
                    </tr>
                    </tfoot>
