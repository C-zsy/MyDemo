...
<div id="center">
    ...
    <div id="main">
        <form name="powerUpdate" method="post" action="powerList.html" onsubmit="return checkpower()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    ...
                    <tbody>
<#--                    <#list powerUpdate as list>-->
                    <tr>
                        <td style="height: 200px; width: 200px">权限名</td>
                        <td>${powerUpdate.resourceName}</td>
                        <td>${powerUpdate.detailsValue}</td>
                    </tr>
<#--                    </#list>-->
                    </tbody>
                    <tfoot>
                    <tr>
                        <td colspan="3">
                            <ul>
                                <li><input name="updatePower" type="button" value="返回"
