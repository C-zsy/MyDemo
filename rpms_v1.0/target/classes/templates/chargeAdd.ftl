...
<div id="center">
    ...
    <div id="main">
        <form name="form1" method="post" action="chargeAdd" onsubmit="return checkcharge()">
            <div id="index">
            </div>
            <div id="table">
                <table>
                    <caption>添加新的收费项目</caption>
                    <thead>
                    </thead>
                    <tbody>
                    <tr>
                        <td>项目名称</td>
                        <td><input name="chargeName" type="text" value=""/></td>
                        <td>请输入中文，不得超过8位数</td>
                    </tr>
                    <tr>
                        <td>收费标准/元/m/月</td>
                        <td><input name="chargeUnit" type="text" value=""/></td>
                        <td>请输入一个浮点型数据</td>
                    </tr>
